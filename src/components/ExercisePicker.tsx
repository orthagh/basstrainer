  ...
  return (
    <div className="flex flex-col gap-3">
      {Object.entries(grouped).map(([category, items]) => (
        <div key={category}>
          <h4 className="text-[10px] font-semibold text-zinc-400 uppercase tracking-wider mb-1 px-1">
            {category}
          </h4>
                ...
                >
                  <div className="flex items-center gap-2 w-full">
                    <span
                      ...
                      title={ex.difficulty}
                    />
                    <span className="text-[13px] font-medium text-zinc-100 truncate flex-1 leading-none">
                      {ex.title}
                    </span>
                    {!progress && (
                  ...
                  {progress && (
                    <div className="flex items-center justify-between w-full pl-4 text-[10px] text-zinc-400">
